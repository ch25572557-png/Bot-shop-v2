...
class OrderSystem:
    ...
    async def complete(self, channel):
        ...
        try:
            ...
            if not ok:
                await channel.send("❌ สต๊อกไม่พอ (รอฟาร์มเติม)")
                return False
    ...
    async def farm_worker(self):
        ...
        while True:
            try:
                ...
                # =====================
                # 🌾 FARM PROCESS (NO VIP / NO PRIORITY)
                # =====================
                await asyncio.sleep(2)
                ...
                await self.send_ticket(order_id, "🌾 ฟาร์มสินค้าแล้ว")
